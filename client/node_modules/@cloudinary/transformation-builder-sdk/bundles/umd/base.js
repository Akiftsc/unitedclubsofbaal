    ...
    ***************************************************************************** */
    ...
    var ResizePadAction = /** @class */ (function (_super) {
        ...
        ResizePadAction.prototype.background = function (backgroundQualifier) {
            var parsedBackgroundQualifier = backgroundQualifier;
    ...
    var GenerativeRemove = /** @class */ (function (_super) {
        ...
        GenerativeRemove.prototype.preparePromptQualifier = function () {
            ...
            var str = "gen_remove:" + new QualifierValue("prompt_" + prompt).toString();
            if (this._detectMultiple) {
        ...
        GenerativeRemove.prototype.preparePromptsQualifier = function () {
            ...
            var str = "gen_remove:" + new QualifierValue("prompt_(" + prompts.join(";") + ")").toString();
            this.addQualifier(new Qualifier("e", str));
        };
        GenerativeRemove.prototype.prepareRegionQualifier = function () {
            var region = this.stringifyRegion(this._regions[0]);
            var str = "gen_remove:" + new QualifierValue("region_" + region).toString();
            this.addQualifier(new Qualifier("e", str));
        };
        GenerativeRemove.prototype.prepareRegionsQualifier = function () {
            ...
            var str = "gen_remove:" + new QualifierValue("region_(" + regions.join(";") + ")").toString();
            this.addQualifier(new Qualifier("e", str));
        };
